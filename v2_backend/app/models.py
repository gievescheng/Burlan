...
class Document(Base):
    ...
    parser_name: Mapped[str] = mapped_column(Text, default="")
    parser_note: Mapped[str] = mapped_column(Text, default="")
    layout_json: Mapped[str] = mapped_column(Text, default="")
    layout_page_count: Mapped[int] = mapped_column(Integer, default=0)
    layout_element_count: Mapped[int] = mapped_column(Integer, default=0)
