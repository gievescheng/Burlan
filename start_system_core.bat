...
cd /d "%~dp0"
set "AUTO_AUDIT_PROJECT_KEY=burlan_qms"
set "AUTO_AUDIT_CONFIG_DIR=%APPDATA%\AutoAudit\burlan_qms"

echo ================================================
echo ISO 9001 Audit Dashboard
echo ================================================
echo.
echo [0/5] Using private runtime folder:
echo     %AUTO_AUDIT_CONFIG_DIR%
echo.
