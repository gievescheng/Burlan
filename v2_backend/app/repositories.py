...
def replace_document(
    ...
    *,
    ...
    if document:
        ...
        document.parser_note = parser_note
        document.layout_json = layout_json
        document.layout_page_count = layout_page_count
        document.layout_element_count = layout_element_count
    else:
